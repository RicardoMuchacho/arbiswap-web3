        ...
        <div className="space-y-4 p-2">
          <div className="flex items-center justify-between">
            ...
            <button 
              ...
              className="p-1 rounded-full hover:bg-dex-secondary/50 transition-colors"
            >
              <X size={18} />
            </button>
          </div>
          ...
          <div className="h-80 overflow-y-auto pr-2 space-y-1">
            {filteredTokens.length > 0 ? (
              filteredTokens.map((token) => (
                <button
                  key={token.address}
                  className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-dex-secondary/50 transition-all"
              ...
              <div className="text-center p-4 text-dex-foreground/70">
                No tokens found
              </div>
            )}
          </div>
